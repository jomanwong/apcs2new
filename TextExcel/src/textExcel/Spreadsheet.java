...
import java.util.regex.*; //i used to use regex to help me figue out what cell to change, however, spreadsheet loc is now used
...
public class Spreadsheet implements Grid{
	...
	private String command; //whatever user inputs, part of the old implementation, used to be checked with regex
	...
	public String processCommand(String inputCommand){
		...
		/*try{
			processCommand(inputCommand); 			//overflow, recursion but in a bad way, but it however, should catch NumberFormatException
