 ...
 * 
 * @author Joman Wong
 * @latest edit 12/7/2016 10:42 PM
 */
...
public class FracCalcPart2{
    ...
    public static int[] parseOperand(String in){
    	...
    	String instance = in.substring(indexOfUnderscore);
    	String wholeNum;
    	String numerator;
    	String denominator;
    	...
    	if(in.indexOf("/") != -1){ //"is it a fraction?"
    		denominator = in.split("/")[1]; //ex. if in = 5_3/4, this is [5_3,(4)]
    		numerator = instance.split("/")[0]; //ex. in in = 5_3/4, this is []
    	}else{
