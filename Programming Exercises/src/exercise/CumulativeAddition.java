...
public class CumulativeAddition{
  public static void main(String[] args){
      ...
      System.out.println("The sum of all even(s) are/is " + sum +",  the largest even number is " + maxEven); //displays sum with largest even number, IF THERE ARE EVENS
      }else{
