package exercise;
//version built off starting code
import java.util.Arrays;

public class ArraysLab3 { //wtf why is this already declared
	/*
	...
	public static int[] append(int[] arr, int num){
		assert (arr.length > 0): "input array is null or empty!";
	...
	public static int[] remove(int[] arr, int idx){
		assert (arr.length >= 2): "input array is null or empty!";
